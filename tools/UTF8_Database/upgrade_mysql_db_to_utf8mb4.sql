...
ALTER TABLE `inq` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
REPAIR TABLE `inq`;
OPTIMIZE TABLE `inq`;

ALTER TABLE `maillog` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
REPAIR TABLE `maillog`;
OPTIMIZE TABLE `maillog`;

ALTER TABLE `mcp_rules` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
REPAIR TABLE `mcp_rules`;
OPTIMIZE TABLE `mcp_rules`;

ALTER TABLE `mtalog` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
REPAIR TABLE `mtalog`;
...
ALTER TABLE `sa_rules` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
REPAIR TABLE `sa_rules`;
OPTIMIZE TABLE `sa_rules`;

ALTER TABLE `saved_filters` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
ALTER TABLE `user_filters` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

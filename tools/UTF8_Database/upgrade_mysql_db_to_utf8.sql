...
ALTER TABLE `audit_log` CONVERT TO CHARACTER SET utf8 COLLATE utf8_unicode_ci;
...
ALTER TABLE `inq` CONVERT TO CHARACTER SET utf8 COLLATE utf8_unicode_ci;
REPAIR TABLE `inq`;
OPTIMIZE TABLE `inq`;

ALTER TABLE `maillog` CONVERT TO CHARACTER SET utf8 COLLATE utf8_unicode_ci;
REPAIR TABLE `maillog`;
OPTIMIZE TABLE `maillog`;

ALTER TABLE `mcp_rules` CONVERT TO CHARACTER SET utf8 COLLATE utf8_unicode_ci;
REPAIR TABLE `mcp_rules`;
OPTIMIZE TABLE `mcp_rules`;

ALTER TABLE `mtalog` CONVERT TO CHARACTER SET utf8 COLLATE utf8_unicode_ci;
REPAIR TABLE `mtalog`;
OPTIMIZE TABLE `mtalog`;

ALTER TABLE `mtalog_ids` CONVERT TO CHARACTER SET utf8 COLLATE utf8_unicode_ci;
REPAIR TABLE `mtalog_ids`;
OPTIMIZE TABLE `mtalog_ids`;

ALTER TABLE `outq` CONVERT TO CHARACTER SET utf8 COLLATE utf8_unicode_ci;
REPAIR TABLE `outq`;
OPTIMIZE TABLE `outq`;

ALTER TABLE `sa_rules` CONVERT TO CHARACTER SET utf8 COLLATE utf8_unicode_ci;
REPAIR TABLE `sa_rules`;
OPTIMIZE TABLE `sa_rules`;

ALTER TABLE `saved_filters` CONVERT TO CHARACTER SET utf8 COLLATE utf8_unicode_ci;
REPAIR TABLE `saved_filters`;
OPTIMIZE TABLE `saved_filters`;

ALTER TABLE `spamscores` CONVERT TO CHARACTER SET utf8 COLLATE utf8_unicode_ci;

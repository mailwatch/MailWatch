 ...
 */
    ...
    require_once('/var/www/html/mailscanner/lib/request/Requests.php');
    ...
    $files['ipv4']['destination'] = '/var/www/html/mailscanner/temp/GeoIP.dat.gz';
    $files['ipv6']['description'] = 'GeoIP IPv6 data file';
    $files['ipv6']['path'] = '/download/geoip/database/GeoIPv6.dat.gz';
    $files['ipv6']['destination'] = '/var/www/html/mailscanner/temp/GeoIPv6.dat.gz';

    $extract_dir = '/var/www/html/mailscanner/temp/';

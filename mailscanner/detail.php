...
if (is_array($quarantined) && (count($quarantined) > 0)) {
    ...
    if (isset($_POST['submit']) && deepSanitizeInput($_POST['submit'], 'url') === 'submit') {
        if (false === checkFormToken('/detail.php ops token', $_POST['formtoken'], $_POST['forminstance'])) {
        ...
        echo '<INPUT TYPE="HIDDEN" NAME="formtoken" VALUE="' . generateFormToken('/detail.php ops token', $forminstance) . '">' . "\n";

...
$sql = "
 SELECT
  ...
  CASE WHEN spamallowlisted>0 THEN '$yes' ELSE '$no' END AS '" . __('spamwl04') . "',
  CASE WHEN spamblocklisted>0 THEN '$yes' ELSE '$no' END AS '" . __('spambl04') . "',
  ...
  CASE WHEN mcpallowlisted>0 THEN '$yes' ELSE '$no' END AS '" . __('mcpwl04') . "',
  CASE WHEN mcpblocklisted>0 THEN '$yes' ELSE '$no' END AS '" . __('mcpbl04') . "',

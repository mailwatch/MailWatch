...
$filter = \MailWatch\Html::start(\MailWatch\Translation::__('toprecipqt42'), 0, false, true);
...
$graphgenerator->tableColumns = [
    'name' => \MailWatch\Translation::__('email42'),
...
$graphgenerator->graphTitle = \MailWatch\Translation::__('top10recipqt42');

         ...
         <OPTION VALUE=\"A\">" . __('admin12') . "</OPTION>
            ...
            case 'edit':
                if (!isset($_GET['submit'])) {
                    ...
                    echo " <TR><TD CLASS=\"heading\">" . __('password12') . "</TD><TD><INPUT style=\"font-family: password; \" TYPE=\"TEXT\" NAME=\"password\" VALUE=\"XXXXXXXX\"></TD></TR>\n";
                    echo " <TR><TD CLASS=\"heading\">" . __('password12') . "</TD><TD><INPUT style=\"font-family: password; \" TYPE=\"TEXT\" NAME=\"password1\" VALUE=\"XXXXXXXX\"></TD></TR>\n";
                    echo " <TR><TD CLASS=\"heading\">" . __('usertype12') . "</TD>
    <TD><SELECT NAME=\"type\">

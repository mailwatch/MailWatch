...
$filter = \MailWatch\Html::start(\MailWatch\Translation::__('messlisting16'), 0, false, false);
...
db_colorised_table($sql, \MailWatch\Translation::__('messlisting16'), true, true);

...
$filter = \MailWatch\Html::start(\MailWatch\Translation::__('topsenderdomvol45'), 0, false, true);
...
$graphgenerator->tableColumns = [
    'name' => \MailWatch\Translation::__('domain45'),
...
$graphgenerator->graphTitle = \MailWatch\Translation::__('top10senderdomvol45');
